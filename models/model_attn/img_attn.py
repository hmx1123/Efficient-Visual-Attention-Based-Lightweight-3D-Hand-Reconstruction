...
from models.model_zoo.InvertedResidual import InvertedResidual, DepthWiseSeparable
...
class img_attn(nn.Module):
    def __init__(self, verts_f_dim, img_f_dim, n_heads=4, d_q=None, d_v=None, dropout=0.1):
        ...
        # )
        # self.Attn = nn.Sequential(
        #     EfficientAdditiveAttnetion(in_dims=verts_f_dim, num_heads=n_heads, dropout=dropout),
        #     EfficientAdditiveAttnetion(in_dims=verts_f_dim, num_heads=n_heads, dropout=dropout),
        # )
